    ...
    <section className="rounded-3xl border border-red-950/45 bg-zinc-950/55 p-6 shadow-lg shadow-black/20 backdrop-blur">
      ...
      <div className="mt-7 space-y-5">
        {editableCosts.map((key) => {
          ...
          return <div key={key} className="rounded-2xl border border-red-950/40 bg-black/25 p-3">
      ...
      <div className="mt-7 rounded-2xl bg-red-600 p-5 text-white shadow-lg shadow-red-950/30"><div className="flex justify-between"><span className="text-lg font-medium">Total cost</span><span className="text-3xl font-bold">${analysis.totalCost.toFixed(2)}</span></div></div>
    </section>
  );
}
