  ...
  return (
    <section className="rounded-3xl border border-sky-950/45 bg-zinc-950/55 p-6 shadow-lg shadow-black/20 backdrop-blur">
      <div className="flex items-center gap-3">
        <Bookmark className="h-6 w-6 text-sky-200" />
        <div>
      ...
      <div className="mt-5 flex items-center justify-between rounded-2xl border border-sky-950/35 bg-black/25 p-4 text-sm"><span>Projected net profit</span><span className="text-lg font-semibold">${analysis.netProfit.toFixed(2)}</span></div>
