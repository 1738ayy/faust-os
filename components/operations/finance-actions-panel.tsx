...
export function FinanceActionsPanel({ data }: { data: OperatingData }) {
  ...
  return <section aria-label="Finance workflows" className="border border-border bg-card">
    <h2 className="border-b border-border px-5 py-4 font-semibold">Finance Workflows</h2>
    <div className="grid gap-5 p-5 lg:grid-cols-2">
      <form className="border border-border p-4" onSubmit={(event) => { event.preventDefault(); void submit(event.currentTarget); }}>
