      ...
      {data.orders.map((order) => {
        ...
        return (
          <article className="faust-surface overflow-hidden" key={order.id}>
            <div className="border-b border-red-950/45 p-5">
              <div className="flex flex-wrap justify-between gap-4">
                <div>
                  <p className="text-sm font-medium text-red-200">{order.marketplace}</p>
            ...
            <div className="grid gap-4 p-5 md:grid-cols-3">
              ...
              <div className="faust-card p-4 text-sm">
                ...
                <p className="mt-3 text-lg font-semibold text-red-100">Contribution {money(profit.contributionProfit)}</p>
              </div>
              <div className="faust-card p-4 text-sm">
                <b>Shipment</b>
            ...
            <div className="grid gap-4 border-t border-red-950/45 p-5 text-xs md:grid-cols-4">
              <div>
                <b>Status timeline</b>
            ...
            <div className="border-t border-red-950/45 p-5 text-xs text-muted-foreground">
