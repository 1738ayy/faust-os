...
const smallButton = "rounded-full border border-slate-700/60 bg-zinc-950/50 px-3 py-1.5 text-xs font-medium transition hover:border-slate-400/50 hover:text-white";
const primaryButton = "rounded-full bg-[#56627f] px-4 py-2 text-sm font-semibold text-white shadow-lg shadow-slate-950/30 transition hover:bg-[#66708d]";
