...
export function PurchasingActionsPanel({ data }: { data: OperatingData }) {
  ...
  return <section aria-label="Purchasing workflows" className="border border-border bg-card">
    <h2 className="border-b border-border px-5 py-4 font-semibold">Purchasing Workflows</h2>
